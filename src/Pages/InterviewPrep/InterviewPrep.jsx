...
function InterviewPrep() {
  ...
  return (
    <DashboardLayout>
      ...
      <div className="container mx-auto pt-4 pb-4 px-4 flex justify-center items-center flex-col md:px-0">
        <h2 className="text-xl color-black font-semibold">Interview Q & A</h2>
        ...
        <div className="grid grid-cols-12  gap-4 mt-5 mb-10">
          ...
          >
            ...
            <div className="flex items-center justify-center mt-5">
              <button
                className="flex items-center gap-3 text-sm text-white font-medium bg-black px-2 py-2 mr-2 rounded text-nowrap cursor-pointer hover:rounded-2xl hover:scale-110 hover:bg-teal-100 transition duration-200 hover:text-black ease-in "
        ...
        >
          {errorMsg && (
            <p className="flex gap-2 text-sm text-teal-600 font-medium">
